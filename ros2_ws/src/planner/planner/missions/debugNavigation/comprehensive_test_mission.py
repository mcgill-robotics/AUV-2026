...
class ComprehensiveTestMission(py_trees.composites.Sequence):
    ...
    def __init__(self, position_tolerance: float, hold_time: float, timeout: float):
        ...
        delay_0 = TimerBehaviour(timer_duration=2.0, name="Delay 0")

        # =====================================================================
        # 1-2. Surge Test (Forward and Backward)
        # =====================================================================
        surge_fwd = BasicActionBehaviour("Surge Forward", move_global(x=7.0, y=0.0, z=test_depth, tolerance=position_tolerance, hold_time=hold_time, timeout=timeout))
        delay_1 = TimerBehaviour(timer_duration=2.0, name="Delay 1")
        ...
        delay_2 = TimerBehaviour(timer_duration=2.0, name="Delay 2")
        ...
        delay_3 = TimerBehaviour(timer_duration=2.0, name="Delay 3")
        
        # Moving to X=2.0 while facing Y forces a right sway
        sway_right = BasicActionBehaviour("Sway Right", move_global(x=7.0, y=0.0, z=test_depth, tolerance=position_tolerance, hold_time=hold_time, timeout=timeout))
        delay_4 = TimerBehaviour(timer_duration=2.0, name="Delay 4")
        ...
        delay_5 = TimerBehaviour(timer_duration=2.0, name="Delay 5")

        turn_fwd_1 = BasicActionBehaviour("Face Forward", set_global_yaw(yaw_rad=0.0, hold_time=hold_time, timeout=timeout))
        delay_6 = TimerBehaviour(timer_duration=2.0, name="Delay 6")
        ...
        delay_9 = TimerBehaviour(timer_duration=2.0, name="Delay 9")
        
        # Moving to X=2.0 while facing 45 degrees forces equal surge and sway
        diag_out = BasicActionBehaviour("Diagonal Out", move_global(x=7.0, y=0.0, z=test_depth, tolerance=position_tolerance, hold_time=hold_time, timeout=timeout))
        delay_10 = TimerBehaviour(timer_duration=2.0, name="Delay 10")
